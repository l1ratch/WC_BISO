...
#### 11. Что такое попадание в кэш/ пропуск кэша?  
...
#### 39. Расскажите о различиях между поисковыми системами, работающими на основе поискового робота, каталогами, управляемыми человеком, и системами метапоиска.  
